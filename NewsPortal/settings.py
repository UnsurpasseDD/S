...
EMAIL_PORT = 465
EMAIL_HOST_USER = 'sava.pan2016@yandex.ru'
EMAIL_HOST_PASSWORD = ''
EMAIL_USE_SSL = True
DEFAULT_FROM_EMAIL = 'sava.pan2016@yandex.ru'
...
#         },
#         'simple_warning': {
#             'format': '%(levelname)s %(asctime)s %(module)s %(process)d %(thread)d %(message)s %(exc_info)s',
#             'datefmt': "%d.%m.%Y %H-%M-%S"
#         },
#
#         'general': {
...
#         },
#         'errors': {
#             'format': '%(levelname)s %(asctime)s %(module)s %(process)d %(thread)d %(message)s %(pathname)s',
#             'datefmt': "%d.%m.%Y %H-%M-%S"
#         },
#         'email': {
#             'format': '%(levelname)s %(asctime)s %(module)s %(process)d %(thread)d %(message)s %(pathname)s',
